      ...
      <div class="p-5 space-y-5">
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-1.5">
            <button v-for="c in (['normal','highContrast','deuteranopia','monochrome'] as const)" :key="c"
              ...
              <span class="flex items-center gap-2 justify-center">
                <span v-if="c === 'normal'" class="w-3 h-3 rounded-full bg-gradient-to-r from-red-400 via-blue-400 to-green-400" />
